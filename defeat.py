...
def defeat():
    ...
    pygame.display.set_caption("Zaudēji...")
    ...
    # Set up fonts
    font = pygame.font.Font("medieval_font.ttf", 67)
    small_font = pygame.font.Font("medieval_font.ttf", 40)
    
    # Render the victory text
    end_text = font.render("Visas dzīvības beidzās.. Nāve tevi pārņem", True, WHITE)

    # Load the background image
    try:
        background_image = pygame.image.load("death.png")  # Replace with your image file name
