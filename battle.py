...
def battle():
    ...
    try:
        ...
        # Dice results
        DMG2 = pygame.image.load("2damage_end.png").convert_alpha()
        DMG2 = pygame.transform.scale(DMG2, (265, 265))
        HEART = pygame.image.load("plusheart_end.png").convert_alpha()
        HEART = pygame.transform.scale(HEART, (265, 265))
        minus_heart = pygame.image.load("minusheart_end.png").convert_alpha()
        minus_heart = pygame.transform.scale(minus_heart, (265, 265))
        SHIELD = pygame.image.load("shield_end.png").convert_alpha()
        SHIELD = pygame.transform.scale(SHIELD, (265, 265))
        DMG = pygame.image.load("damage_end.png").convert_alpha()
        DMG = pygame.transform.scale(DMG, (265, 265))
        MISS = pygame.image.load("miss_end.png").convert_alpha()
        MISS = pygame.transform.scale(MISS, (265, 265))
        
        # Animations
        dice_frames = load_gif_frames("dice.gif")
        slash_frames = load_gif_frames("slash.gif")
