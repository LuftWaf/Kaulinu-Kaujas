...
def defeat():
    ...
    # Set up fonts
    font = pygame.font.Font("font_assets/medieval_font.ttf", 67)
    ...
    try:
        background_image = pygame.image.load("background_assets/death.png")  # Replace with your image file name
