...
def battle():
    ...
    try:
        # Background
        background = pygame.image.load("boss_assets/boss_battle1.png").convert()
        background = pygame.transform.scale(background, (width, height))

        # Background2
        background2 = pygame.image.load("boss_assets/boss_battle2.png").convert()
        background2 = pygame.transform.scale(background2, (width, height))

        background3 = pygame.image.load("boss_assets/boss_battle3.png").convert()
        background3 = pygame.transform.scale(background3, (width, height))

        background4 = pygame.image.load("boss_assets/boss_battle4.png").convert()
        background4 = pygame.transform.scale(background4, (width, height))

        background5 = pygame.image.load("boss_assets/boss_battle5.png").convert()
        background5 = pygame.transform.scale(background5, (width, height))

        background6 = pygame.image.load("boss_assets/boss_battle6.png").convert()
        background6 = pygame.transform.scale(background6, (width, height))

        background7 = pygame.image.load("boss_assets/boss_battle7.png").convert()
    ...
    while running:
        ...
        if HP < 6:
            ...
            if HP == 0:
                ...
                if (current_time - last_click_time > 2000 and 
                    ...
                    pygame.quit()
                    subprocess.run(["python3", "defeat.py"])
                    sys.exit()
        ...
        # Current health
        current_enemy_health_width = max(0, (enemy_health_width * enemy_HP) // 20)
