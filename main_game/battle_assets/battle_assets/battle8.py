...
def battle():
    ...
    try:
        ...
        # Enemies
        enemy = pygame.image.load("enemy_assets/fallen.png")
    ...
    while running:
        ...
        if enemy:
            screen.blit(enemy, (width // 2 + 410 - enemy.get_width() // 2, height // 2 - 360))
        ...
        enemy_health_x = width // 2  - enemy_health_width // 2  + 420
        enemy_health_y = height // 2 - 350
        ...
        # Current health
        current_enemy_health_width = max(0, (enemy_health_width * enemy_HP) // 10)
