...
def victory_screen():
    ...
    # Set up fonts
    font = pygame.font.Font("medieval_font.ttf", 69)
    rules_small_font = pygame.font.Font("medieval_font.ttf", 22)
    button_font = pygame.font.Font("medieval_font.ttf", 50)
    motivation_font = pygame.font.Font("medieval_font.ttf", 28)

     # Load the background image
    try:
        background_image = pygame.image.load("tutorial.png")  # Replace with your image file name
